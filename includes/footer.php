...
?>
    ...
    if ($flash):
        ...
        $alertClass = $alertClasses[$flash['type']] ?? $alertClasses['info'];
    ?>
        <div id="flashMessage" class="fixed top-4 right-4 z-50 p-4 rounded-lg shadow-lg max-w-sm <?php echo $alertClass; ?>">
