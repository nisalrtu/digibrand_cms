...
<head>
    ...
    <title><?php echo $pageTitle ?? 'Digibrand CRM'; ?></title>
    ...
    >
        ...
        <div class="p-4 space-y-2">
            ...
            <a href="<?php echo Helper::baseUrl('modules/employees/'); ?>" 
               class="nav-item flex items-center space-x-3 px-3 py-2.5 rounded-lg text-gray-700 hover:text-gray-900 hover:bg-gray-100 <?php echo (strpos($_SERVER['REQUEST_URI'], 'employees') !== false) ? 'active text-white' : ''; ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="<?php echo Helper::baseUrl('modules/expenses/'); ?>" 
               class="nav-item flex items-center space-x-3 px-3 py-2.5 rounded-lg text-gray-700 hover:text-gray-900 hover:bg-gray-100 <?php echo (strpos($_SERVER['REQUEST_URI'], 'expenses') !== false) ? 'active text-white' : ''; ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Settings -->
            <a href="<?php echo Helper::baseUrl('modules/settings/'); ?>" 
               class="nav-item flex items-center space-x-3 px-3 py-2.5 rounded-lg text-gray-700 hover:text-gray-900 hover:bg-gray-100 <?php echo (strpos($_SERVER['REQUEST_URI'], 'settings') !== false) ? 'active text-white' : ''; ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
